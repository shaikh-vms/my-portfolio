            ...
            >
                <p className="text-white text-xl mb-4">
                    Developed with <motion.span 
                        ...
                        ❤
                    </motion.span> by Vasim 
                </p>
                
                <div className="flex justify-center space-x-6 text-white mb-6">
                <a href="https://www.linkedin.com/in/vasim-shaikh-4ba483199/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className='text-white transition ease-in-out delay-100 hover:-translate-y-1' size={24}></FaLinkedin>
              </a>
              <a href="https://leetcode.com/u/shaikhvms/" target="_blank" rel="noopener noreferrer"> 
                ...
                <a href="https://www.instagram.com/shaikh_vms" target="_blank" rel="noopener noreferrer"> 
                <FaInstagram className='text-white transition ease-in-out delay-100 hover:-translate-y-1' size={24}></FaInstagram></a>
                <a href="https://github.com/shaikh-vms" target="_blank" rel="noopener noreferrer"> 
                <FaGithub className='text-white transition ease-in-out delay-100 hover:-translate-y-1' size={24}></FaGithub> </a>
                <a href="https://x.com/shaikhvms" target="_blank" rel="noopener noreferrer"> 
                ...
                <p className="text-white text-sm">
                    © {currentYear} Vasim Shaikh. All Rights Reserved.
                </p>
            </motion.div>
        </footer>
    );
